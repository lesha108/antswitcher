...
#
# s9switcher.tcl: Tcl script for re-creating project 's9switcher'
#
# Generated by Vivado on Sun Jul 13 16:13:38 +0300 2025
...
#
# 1. This project restoration tcl script (s9switcher.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/sources_1/imports/src/ad_iobuf.v"
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/sources_1/new/khz_gen.v"
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/sources_1/imports/system_bd_wrapper.v"
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/constrs_1/new/constraints.xdc"
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/sim_1/imports/src/mux144_tb.v"
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/sim_1/imports/src/seq144_tb.v"
#    "F:/Xilinx/projects/s9switcher/s9switcher.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/s9switcher.srcs/sources_1/imports/src/ad_iobuf.v"]"\
 "[file normalize "$origin_dir/s9switcher.srcs/sources_1/new/khz_gen.v"]"\
 "[file normalize "$origin_dir/s9switcher.srcs/sources_1/imports/system_bd_wrapper.v"]"\
 "[file normalize "$origin_dir/s9switcher.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/s9switcher.srcs/sim_1/imports/src/mux144_tb.v"]"\
 "[file normalize "$origin_dir/s9switcher.srcs/sim_1/imports/src/seq144_tb.v"]"\
 "[file normalize "$origin_dir/s9switcher.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
   [file normalize "$origin_dir/../s9base/ip_repo/sequencerip_1_0"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "s9switcher"
...
set script_file "s9switcher.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../s9base/ip_repo/sequencerip_1_0"]" $obj
...
set file "imports/system_bd_wrapper.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
...
set file "[file normalize ${origin_dir}/s9switcher.srcs/constrs_1/new/constraints.xdc]"
...
set_property -name "top" -value "mux144_tb" -objects $obj
...
if { [get_files ad_iobuf.v] == "" } {
  import_files -quiet -fileset sources_1 F:/Xilinx/projects/s9switcher/s9switcher.srcs/sources_1/imports/src/ad_iobuf.v
}
if { [get_files ad_iobuf.v] == "" } {
  import_files -quiet -fileset sources_1 F:/Xilinx/projects/s9switcher/s9switcher.srcs/sources_1/imports/src/ad_iobuf.v
}
...
if { [get_files khz_gen.v] == "" } {
  import_files -quiet -fileset sources_1 F:/Xilinx/projects/s9switcher/s9switcher.srcs/sources_1/new/khz_gen.v
}
...
# module references:
# ad_iobuf, ad_iobuf, ad_iobuf, ad_iobuf, khz_gen
  ...
  # Create ports
  set Buzzer_O [ create_bd_port -dir O -from 0 -to 0 Buzzer_O ]
  ...
  # Create instance: BuzzerCtrl, and set properties
  set BuzzerCtrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BuzzerCtrl ]
  ...
  # Create instance: ControlPins, and set properties
  set ControlPins [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 ControlPins ]
  set_property -dict [list \
    CONFIG.DIN_FROM {6} \
    CONFIG.DIN_TO {3} \
    CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: ad_iobuf_SCL1, and set properties
  set block_name ad_iobuf
  set block_cell_name ad_iobuf_SCL1
  if { [catch {set ad_iobuf_SCL1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ad_iobuf_SCL1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: ad_iobuf_SDA1, and set properties
  set block_name ad_iobuf
  set block_cell_name ad_iobuf_SDA1
  if { [catch {set ad_iobuf_SDA1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ad_iobuf_SDA1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: khz_gen_0, and set properties
  set block_name khz_gen
  set block_cell_name khz_gen_0
  if { [catch {set khz_gen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $khz_gen_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
...
\
  ...
  connect_bd_net -net BuzzerCtrl_Dout [get_bd_pins BuzzerCtrl/Dout] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net ControlPins_Dout [get_bd_pins ControlPins/Dout] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net Net [get_bd_ports I2C1_SDA] [get_bd_pins ad_iobuf_SDA1/dio_p]
  ...
  connect_bd_net -net Net3 [get_bd_ports I2C1_SCL] [get_bd_pins ad_iobuf_SCL1/dio_p]
  ...
  connect_bd_net -net ad_iobuf_SCL1_dio_o [get_bd_pins ad_iobuf_SCL1/dio_o] [get_bd_pins processing_system7_0/I2C1_SCL_I]
  connect_bd_net -net ad_iobuf_SDA1_dio_o [get_bd_pins ad_iobuf_SDA1/dio_o] [get_bd_pins processing_system7_0/I2C1_SDA_I]
  ...
  connect_bd_net -net khz_gen_0_buzzer_out [get_bd_pins khz_gen_0/buzzer_out] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins khz_gen_0/sys_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins BuzzerCtrl/Din] [get_bd_pins ControlPins/Din] [get_bd_pins LCD/Din] [get_bd_pins processing_system7_0/GPIO_O]
  ...
  connect_bd_net -net processing_system7_0_I2C1_SCL_O [get_bd_pins ad_iobuf_SCL1/dio_i] [get_bd_pins processing_system7_0/I2C1_SCL_O]
  connect_bd_net -net processing_system7_0_I2C1_SCL_T [get_bd_pins ad_iobuf_SCL1/dio_t] [get_bd_pins processing_system7_0/I2C1_SCL_T]
  connect_bd_net -net processing_system7_0_I2C1_SDA_O [get_bd_pins ad_iobuf_SDA1/dio_i] [get_bd_pins processing_system7_0/I2C1_SDA_O]
  connect_bd_net -net processing_system7_0_I2C1_SDA_T [get_bd_pins ad_iobuf_SDA1/dio_t] [get_bd_pins processing_system7_0/I2C1_SDA_T]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins khz_gen_0/sys_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net rx_0_1 [get_bd_ports ulite_rx_I_0] [get_bd_pins axi_uartlite_0/rx]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports Buzzer_O] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports Dout_1] [get_bd_pins util_vector_logic_1/Res]
...
if { [get_property IS_LOCKED [ get_files -norecurse system_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/s9switcher.gen/sources_1/bd/system_bd/hdl/system_bd_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/s9switcher.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/s9switcher.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "F:/Xilinx/projects/s9base/s9base.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "F:/Xilinx/projects/s9base/s9base.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
